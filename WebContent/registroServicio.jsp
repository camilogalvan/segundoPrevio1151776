        ...
        <div class="container">
          <div class="row">
            <div class="col-md-9 col-lg-8 mx-auto">
              ...
              <form action="${pageContext.request.contextPath}/ServicioServlet?action=insert" method="post">
                <div class="form-label-group">
                  <input type="text" id="inputNombre" class="form-control" placeholder="Nombre" name="nombre"required autofocus>
                  <label for="inputNombre">Nombre</label>
                </div>
                <div class="form-label-group">
                  <input type="text" id="inputLema" class="form-control" placeholder="Descripcion" name="descripcion" required autofocus>
