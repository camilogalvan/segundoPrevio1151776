        ...
        <div class="container">
          <div class="row">
            <div class="col-md-9 col-lg-8 mx-auto">
              ...
              <form action="${pageContext.request.contextPath}/TiendaServlet?action=insert" method="post">
              ...
              <!--Validar Correo-->              
               <% 
            if(request.getAttribute("correoRepetido")!=null) 
            { 
        %>          
                <script>alert(""+<%=request.getAttribute("correoRepetido")%>)</script>
        <%
            }
                %>
            </div>
